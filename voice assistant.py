...
def get_response(user_input):
    ...
    responses = {
        ...
        "what's your name": ["I'm a chatbot without a specific name.", "I don't have a name, but you can call me Chatbot.", "You can call me Chatbot."],
...
def main():
    ...
    while True:
        user_input = listen()
        if user_input and "hello iris" in user_input.lower():
